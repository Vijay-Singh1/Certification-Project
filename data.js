...
var teamList=[
    ...
    {   "id":0,
        ...
        "top-batter":"Top Batter : Virat-kohli",
        "top-bowler":"Top Bowler : Harshal Patel"
    }
...
var productList = [
  ...
  heading2.innerHTML = "Accessories for Men and Women";
  
  main.appendChild(heading1);
  main.appendChild(clothing);
  main.appendChild(heading2);
  main.appendChild(accessories);
  ...
  for (i = 0; i < productList.length; i++) {
    ...
    var des1 = document.createElement("h3");
    des1.classList.add("des1");
    var des2 = document.createElement("h5");
    des2.classList.add("des2");
    des2.innerHTML = "Rs 2500";
    var des3 = document.createElement("h4");
    des3.classList.add("des3");
    des3.innerHTML = "United colors of Benetton";
  
    var des4 = document.createElement("h5");
    des4.classList.add("des4");
    des4.innerHTML = "Rs 2500";
   
  
    des.appendChild(des1);
    des.appendChild(des2);
    des.appendChild(des3);
    des.appendChild(des4);
  
    if (productList[i].isTeam === true) {
      img.src = productList[i].preview;
      des1.innerHTML = productList[i].name;
      des2.innerHTML = productList[i].PlayerCount;
      des3.innerHTML = productList[i].TopBatter;
      des4.innerHTML = productList[i].TopBowler;
      
  
      product.appendChild(pro_img);
      product.appendChild(des);
      clothing.appendChild(product);
    } else {
      img.src = productList[i].preview;
      des1.innerHTML = productList[i].name;
      des2.innerHTML = productList[i].TopBatter;
      des3.innerHTML = productList[i].TopBowler;
      product.appendChild(pro_img);
      product.appendChild(des);
      accessories.appendChild(product);
    }
  }
